...
$(document).ready(function () {
    ...
    $(".btn-avancar").click(function (e) {
        ...
        if (imagens_novas.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (uploadCount === imagens_novas.length) {
                            ...
                            atualizarPublicacao(todas_urls);
                        }
                    },
                    error: function () {
            ...
            atualizarPublicacao(urls_existentes);
        }

        function atualizarPublicacao(urls) {
            const id_publicacao = $("#id_publicacao").val();
            ...
            $.ajax({
                url: "../banco/editarPublicacao.php",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                success: function(resposta) {
                    ...
                    window.location.href = `../Publicacao.php?id=${id_publicacao}`;
                },
                error: function() {
                    $('#msg').text("Erro ao atualizar publicação.").fadeIn().delay(2000).fadeOut();
                }
            });
        }
    });
